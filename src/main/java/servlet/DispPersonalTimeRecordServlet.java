 ...
 */
@WebServlet("/DispPersonalTimeRecordServlet")
public class DispPersonalTimeRecordServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public DispPersonalTimeRecordServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/PersonalTimeRecord.jsp").forward(request, response);
	}
}
