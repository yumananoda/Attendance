...
const getDateAndDay = () => {
  ...
  for (let i = 1; i <= endDate.getDate(); i++) {
    ...
    clockIn.classList.add("item2");
    clockOut.classList.add("item2");
    clock.classList.add("item2");
    breakTime.classList.add("item2");
    shiftClockIn.classList.add("item2");
  ...
  const total_table = document.createElement("table");
  total_table.classList.add("total_table");
  ...
  total_th1.classList.add("item1");
  total_td1.classList.add("item2");
  ...
  total_table.appendChild(total_tr1);
  totalDataArea.appendChild(total_table);
  ...
  total_th2.classList.add("item1");
  total_td2.classList.add("item2");
  ...
  total_table.appendChild(total_tr2);
  totalDataArea.appendChild(total_table);
  console.log();
  ...
  total_th3.classList.add("item1");
  total_td3.classList.add("item2");
  ...
  total_table.appendChild(total_tr3);
  totalDataArea.appendChild(total_table);
  ...
  total_th4.classList.add("item1");
  total_td4.classList.add("item2");
  ...
  total_table.appendChild(total_tr4);
  totalDataArea.appendChild(total_table);
  ...
  prescribed_th1.classList.add("item1");
  prescribed_td1.classList.add("item2");
  ...
  total_table.appendChild(prescribed_tr1);
  prescribedArea.appendChild(total_table);
  ...
  prescribed_th2.classList.add("item1");
  prescribed_td2.classList.add("item2");
  ...
  total_table.appendChild(prescribed_tr2);
  prescribedArea.appendChild(total_table);
