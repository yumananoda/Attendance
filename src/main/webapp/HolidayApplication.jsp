		...
		<form action="HolidayApplicationConfirmServlet" method="post" id="HolidayForm">
			<div class="content tab-01 is-display">
				<table>
					...
					<tr>
						<th>日付</th>
						<td><input type="date" id="applicationDate1" name="startDate" />～
						<input type="date" id="applicationDate2" name="endDate" /></td>
					</tr>
					<tr>
						<th>事由</th>
						<td><textarea name="reason" placeholder="申請理由を入力してください。"></textarea></td>
					</tr>
					<tr>
						<th>備考</th>
			...
			<div class="content tab-02">
				<table>
					...
					<tr>
						<th>日付</th>
						<td><input type="date" id="applicationDate3" name="startDate" />～
						<input type="date" id="applicationDate4" name="endDate" /></td>
					</tr>
					<tr>
						<th>事由</th>
						<td><textarea name="reason" placeholder="申請理由を入力してください。"></textarea></td>
